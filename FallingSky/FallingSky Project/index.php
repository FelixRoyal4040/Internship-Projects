...
<head>
  ...
  <link rel="stylesheet" href="css/pre-footer.css">
...
<body>
  <header>
    <div>
    <div>
      <a href=""><img src="images/sky.png" alt="" width="60"></a>
  ...
  <div class="conteiner">
    <section>
      <marquee behavior="" direction=""><h1 style="margin-top: 100px;">BEM-VINDO AO APP</h1></marquee>
    </section>
  </div>
    ...
    <section>
      <div>
        ...
        <div style="margin-top: 20px;">
          <p>Consectetur adipi elit lorem </p>
          <p> ipsum dolor sit ament.</p>
        </div>
        <br>
        <button class="learn-button">Saiba mais </button>
      </div>
    </section>
    <section>
  ...
  <div class="footer-conteiner">
    ...
    <br>
    <br>
    <div class="sla-conteiner">
    <h1>Fale connosco</h1>
      <div>Contacte-nos para obter qualquer feedback que for necessário. A nossa equipa está pronta para fonecer o máximo de ajuda que for necessária.</div>
    </div>
  ...
  <div class="footer-secundaria">
    <hr>
    <p>© 2020 All Rights Reserved. Design by canga dev</p>
  </div>
</body>
</html>